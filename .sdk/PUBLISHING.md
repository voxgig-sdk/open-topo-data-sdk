...
|---|---|---|
| `ts/` | @voxgig-sdk/open-topo-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/open-topo-data-sdk \
      --repository voxgig-sdk/open-topo-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/open-topo-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/open-topo-data-sdk --id=<id>` removes it.
