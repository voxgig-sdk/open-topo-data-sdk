...
// OpenTopoData SDK cache feature
...
class OpenTopoDataCacheFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _through(OpenTopoDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
