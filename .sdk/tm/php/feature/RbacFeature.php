...
class OpenTopoDataRbacFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _required(OpenTopoDataContext $ctx): ?string
    {
    ...
    private function _reject(OpenTopoDataContext $ctx, string $required): void
    {
    ...
    private function _track(OpenTopoDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
