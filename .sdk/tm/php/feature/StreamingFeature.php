...
// OpenTopoData SDK streaming feature
...
class OpenTopoDataStreamingFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _iterate(OpenTopoDataResult $result): \Generator
    {
    ...
    private function _streamable(OpenTopoDataContext $ctx): bool
    {
