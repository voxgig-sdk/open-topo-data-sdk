...
// OpenTopoData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = OpenTopoDataOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(OpenTopoDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(OpenTopoDataOmni::structfix($val, Struct::undef()))) {
