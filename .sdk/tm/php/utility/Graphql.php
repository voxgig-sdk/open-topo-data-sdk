...
// OpenTopoData SDK utility: graphql
//
...
class OpenTopoDataGraphql
{
    ...
    // equivalent.
    public static function body(OpenTopoDataContext $ctx): mixed
    {
    ...
    public static function errors(OpenTopoDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
