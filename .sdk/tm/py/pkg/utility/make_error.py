...
from projectname_sdk.core.control import OpenTopoDataControl
from projectname_sdk.core.error import OpenTopoDataError


def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import OpenTopoDataContext
        ctx = OpenTopoDataContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, OpenTopoDataError):
        errmsg = err.msg
    ...
    sdk_err = OpenTopoDataError("", msg, ctx)
