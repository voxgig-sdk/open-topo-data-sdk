...
class OpenTopoDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenTopoDataTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenTopoDataTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenTopoDataTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
