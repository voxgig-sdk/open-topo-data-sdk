...
Results: Successful response with elevation data.
...
| --- | --- | --- | --- |
| GetElevation | `list` | `GET /{dataset}` | See reference |

## Connect to the API

- Public API server: `https://api.opentopodata.org/v1`
- Local development server: `http://localhost:5000/v1`
...
- `open-topo-data_list`: List records for an entity. Supported entities: `get_elevation`.
- `open-topo-data_load`: Load one record for an entity. No active entity supports this operation.
