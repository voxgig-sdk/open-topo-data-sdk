...
AQL-driven CLI and REPL for the OpenTopoData SDK. Positional arguments are
...
./open-topo-data-cli load 1 get_elevation
./open-topo-data-cli load '{id:1}' get_elevation
