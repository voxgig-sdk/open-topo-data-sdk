...
func registerSDKWords(r *eng.Registry, client *sdk.OpenTopoDataSDK) {
...
func runOp(client *sdk.OpenTopoDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
