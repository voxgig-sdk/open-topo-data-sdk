// Command OpenTopoData-mcp is an MCP server exposing the OpenTopoData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OpenTopoData_list  — list records of an entity
//	OpenTopoData_load  — load a single record of an entity
//
