...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_elevation"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenTopoDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-topo-data_list",
		Description: "List records from OpenTopoData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-topo-data_load",
		Description: "Load a single record from OpenTopoData. " +
...
func runOp(client *sdk.OpenTopoDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenTopoDataSDK, name string) (sdk.OpenTopoDataEntity, error) {
	switch strings.ToLower(name) {
	case "get_elevation":
		return client.GetElevation(nil), nil
