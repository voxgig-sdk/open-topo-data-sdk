...
func (sdk *OpenTopoDataSDK) OptionsMap() map[string]any {
...
func (sdk *OpenTopoDataSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenTopoDataSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenTopoDataSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenTopoDataSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenTopoDataSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenTopoDataSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenTopoDataSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenTopoDataSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenTopoDataSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenTopoDataSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenTopoDataSDK {
	...
	sdk := NewOpenTopoDataSDK(sdkopts)
	sdk.Mode = "test"
