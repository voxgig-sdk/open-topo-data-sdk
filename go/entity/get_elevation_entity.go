...
func NewGetElevationEntity(client *core.OpenTopoDataSDK, entopts map[string]any) *GetElevationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetElevationEntity) GetName() string { return e.name }
...
func (e *GetElevationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetElevationEntity) Deleted() bool {
	return e.deleted
}


func (e *GetElevationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetElevationEntity(e.client, opts)
}

func (e *GetElevationEntity) Data(args ...any) any {
...
func (e *GetElevationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetElevation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetElevationEntity) DataTyped(data ...GetElevation) GetElevation {
	if len(data) > 0 {
		return typedFrom[GetElevation](e.Data(asMap(data[0])))
	}
	return typedFrom[GetElevation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetElevation (all fields
// optional at the wire level).
func (e *GetElevationEntity) MatchTyped(match ...GetElevation) GetElevation {
	if len(match) > 0 {
		return typedFrom[GetElevation](e.Match(asMap(match[0])))
	}
	return typedFrom[GetElevation](e.Match())
}
...
func (e *GetElevationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetElevationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GetElevationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetElevationListMatch and returns []GetElevation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GetElevationEntity) ListTyped(reqmatch GetElevationListMatch, ctrl map[string]any) ([]GetElevation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GetElevation](res), nil
}



func (e *GetElevationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetElevationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetElevationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetElevationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
