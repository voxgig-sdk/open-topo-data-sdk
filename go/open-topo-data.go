...
// instead of `sdk.NewOpenTopoDataSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpenTopoDataSDK  { return NewOpenTopoDataSDK(nil) }
func Test() *OpenTopoDataSDK { return TestSDK(nil, nil) }
