...
local GetElevationEntity = {}
GetElevationEntity.__index = GetElevationEntity


function GetElevationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetElevationEntity)
  self._name = "get_elevation"
  self._client = client
...
function GetElevationEntity:get_name()
  return self._name
end


function GetElevationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetElevationEntity.new(self._client, opts)
end
...
function GetElevationEntity:mark_deleted()
  self._deleted = true
end


function GetElevationEntity:deleted()
  return true == self._deleted
end


function GetElevationEntity:data_set(args)
  if args ~= nil then
...
function GetElevationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetElevationEntity:match_set(args)
  if args ~= nil then
...
function GetElevationEntity:match_get()
...
function GetElevationEntity:stream(action, args, callopts)
...
function GetElevationEntity:_run_op(ctx, post_done)
  local utility = self._utility
