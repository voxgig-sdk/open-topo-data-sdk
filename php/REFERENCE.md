# OpenTopoData PHP SDK Reference

Complete API reference for the OpenTopoData PHP SDK.
...
#### `OpenTopoDataSDK::test($testopts = null, $sdkopts = null)`
