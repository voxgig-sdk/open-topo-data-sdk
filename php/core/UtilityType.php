...
// OpenTopoData SDK utility type

class OpenTopoDataUtility
{
    ...
    public static function copy(OpenTopoDataUtility $src): OpenTopoDataUtility
    {
        $u = new OpenTopoDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
