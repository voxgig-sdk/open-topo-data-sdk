...
// OpenTopoData SDK audit feature
...
class OpenTopoDataAuditFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _emit(OpenTopoDataContext $ctx, string $outcome): void
    {
