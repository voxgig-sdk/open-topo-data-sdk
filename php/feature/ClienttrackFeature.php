...
// OpenTopoData SDK clienttrack feature
...
class OpenTopoDataClienttrackFeature extends OpenTopoDataBaseFeature
{
    ...
    public function PostConstruct(OpenTopoDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenTopoData-SDK';
