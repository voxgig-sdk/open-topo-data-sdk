...
// OpenTopoData SDK debug feature
...
class OpenTopoDataDebugFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _finish(OpenTopoDataContext $ctx, bool $ok): void
    {
