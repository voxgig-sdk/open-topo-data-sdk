...
// OpenTopoData SDK idempotency feature
...
class OpenTopoDataIdempotencyFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _mutating(OpenTopoDataContext $ctx): bool
    {
