...
// OpenTopoData SDK metrics feature
...
class OpenTopoDataMetricsFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _record(OpenTopoDataContext $ctx, bool $ok): void
    {
