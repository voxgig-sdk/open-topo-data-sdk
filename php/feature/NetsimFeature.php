...
// OpenTopoData SDK netsim feature
...
class OpenTopoDataNetsimFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _simulate(OpenTopoDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenTopoDataContext $ctx, array $applied): void
    {
        $client = $this->client;
