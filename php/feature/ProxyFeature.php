...
// OpenTopoData SDK proxy feature
...
class OpenTopoDataProxyFeature extends OpenTopoDataBaseFeature
{
    ...
    public function init(OpenTopoDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenTopoDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
