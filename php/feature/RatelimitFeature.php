...
// OpenTopoData SDK ratelimit feature
...
class OpenTopoDataRatelimitFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _acquire(OpenTopoDataContext $ctx): void
    {
    ...
    private function _track(OpenTopoDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
