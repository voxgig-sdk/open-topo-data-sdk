...
// OpenTopoData SDK telemetry feature
...
class OpenTopoDataTelemetryFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _close(OpenTopoDataContext $ctx, bool $ok): void
    {
