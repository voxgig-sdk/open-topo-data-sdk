...
// OpenTopoData SDK timeout feature
...
class OpenTopoDataTimeoutFeature extends OpenTopoDataBaseFeature
{
    ...
    private function _with_timeout(OpenTopoDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenTopoDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
