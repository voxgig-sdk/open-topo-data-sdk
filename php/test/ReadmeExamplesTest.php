...
// OpenTopoData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenTopoDataSDK::test)
...
{
    private const SDK_CLASS = 'OpenTopoDataSDK';
    ...
    private const SDK_BASE = 'opentopodata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../opentopodata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
