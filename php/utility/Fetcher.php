...
// OpenTopoData SDK utility: fetcher

class OpenTopoDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenTopoDataSDK/1.0)';
    ...
    public static function call(OpenTopoDataContext $ctx, string $fullurl, array $fetchdef): array
    {
