...
// OpenTopoData SDK utility: make_options

class OpenTopoDataMakeOptions
{
    ...
    public static function call(OpenTopoDataContext $ctx): array
    {
        ...
        //
        // `OpenTopoDataSchema::optspec()` is built from the model:
        ...
        $optspec = OpenTopoDataSchema::optspec();
