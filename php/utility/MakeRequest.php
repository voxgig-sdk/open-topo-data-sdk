...
// OpenTopoData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenTopoDataMakeRequest
{
    public static function call(OpenTopoDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenTopoDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenTopoDataResponse($fetched);
        } else {
