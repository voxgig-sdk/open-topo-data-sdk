...
// OpenTopoData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class OpenTopoDataTransformResponse
{
    public static function call(OpenTopoDataContext $ctx): mixed
    {
        ...
        $transform = OpenTopoDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
