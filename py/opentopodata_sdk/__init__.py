...
from opentopodata_sdk.utility import register

# Load features
from opentopodata_sdk.feature.base_feature import OpenTopoDataBaseFeature
from opentopodata_sdk.features import _has_feature, _make_feature
...
class OpenTopoDataSDK:
    ...
    def get_utility(self):
        return OpenTopoDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenTopoDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetElevation(self, data=None) -> "GetElevationEntity":
        ...
        from opentopodata_sdk.entity.get_elevation_entity import GetElevationEntity
