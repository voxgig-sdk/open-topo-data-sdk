...
from opentopodata_sdk.opentopodata_types import (
    GetElevation,
...
class GetElevationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetElevationEntity(self._client, opts)
    ...
    def data_get(self) -> GetElevation:
    ...
    def match_get(self) -> GetElevation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GetElevation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GetElevation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
