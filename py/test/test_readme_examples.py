# OpenTopoData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenTopoDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenTopoDataSDK(...) and OpenTopoDataSDK.test(...) become
#      OpenTopoDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "opentopodata_sdk"
_SDK_CLASS = "OpenTopoDataSDK"
