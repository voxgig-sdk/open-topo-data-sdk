...
#      offline in seeded test mode (OpenTopoDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenTopoData_sdk.rb")
  SDK_CLASS = "OpenTopoDataSDK"
